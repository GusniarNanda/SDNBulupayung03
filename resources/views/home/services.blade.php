  ...
  <body>
      ...
      <div class="container">
        <div class="title-container">
          ...
          <div class="row mt-5">
            <div class="col-md-4">
              <div
                class="card border-0 text-center p-4 mt-3"
                data-aos="zoom-in"
              >
                <div class="card-body">
                  <div class="card-icon">
    ...
    <div class="features mt-5 py-5">
        <div class="container">
            ...
            <p class="text-center mt-4">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Voluptatibus autem cupiditate odio amet illo dolorum facilis deleniti minima magnam et laborum earum, officiis nulla fugiat enim molestias expedita! Unde, nostrum.</p>
            <div class="row mt-5">
                <div class="col-md-3">
